                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "CarRentalAPI.WebAPI");
                        ...
                        //
                        c.IncludeXmlComments(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase), "CarRentalAPI.WebAPI.XML"));
